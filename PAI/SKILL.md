...
`curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"voice_id":"${ELEVENLABS_VOICE_ID}","message": "Entering the PAI Algorithm Observe phase"}'`
...
```
`curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"voice_id":"${ELEVENLABS_VOICE_ID}","message": "Entering the Think phase"}'`
...
```
`curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"voice_id":"${ELEVENLABS_VOICE_ID}","message": "Entering the Plan phase"}'`
...
```
`curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"voice_id":"${ELEVENLABS_VOICE_ID}","message": "Entering the Build phase"}'`
...
```
`curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"voice_id":"${ELEVENLABS_VOICE_ID}","message": "Entering the Execute phase"}'`
...
```
`curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"voice_id":"${ELEVENLABS_VOICE_ID}","message": "Entering the Verify phase."}'`
...
```
`curl -s -X POST http://localhost:8888/notify -H "Content-Type: application/json" -d '{"voice_id":"${ELEVENLABS_VOICE_ID}","message": "Entering the Learn phase"}'`
